...
*
**/
contract TRLConstrained is TRLInterface, Ownable {
    ...
    // Minimum stake to participate in the period
    ...
    **/
    ...
    function buyTokenVotes(uint256 _amount) public {
        ...
        require(_amount + votesBalance[currentPeriod()][msg.sender] >= minimumStakeAmount);
    ...
    **/
    ...
    function vote(address _candidateAddress, uint256 _amount) public {
     ...
     /**
    * @dev Sets the minimum stake to participate in the period. 
    * @param _minimumStakeAmount amount to be set as a minimum
    **/

    function setMinimumStake(uint256 _minimumStakeAmount) public {
        require(msg.sender == owner);
        minimumStakeAmount = _minimumStakeAmount;
        MinimumStakeSet(_minimumStakeAmount);
    }
