...
contract Balance is Ownable {
		...
		function withdraw(address _entity, address _tokenAddress, uint256 ammountWithdrawn, uint256 _period) external {
				...
				entityBalanceForPeriod[_period][_tokenAddress][_entity] = currentBalance.sub(ammountWithdrawn);
